...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand fw-bold" href="<?= base_url('admin/artikel'); ?>">
                <i class="bi bi-newspaper me-2"></i>Admin Portal Berita
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link <?= uri_string() == 'admin/artikel' ? 'active' : '' ?>" href="<?= base_url('admin/artikel'); ?>">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= uri_string() == 'admin/artikel/add' ? 'active' : '' ?>" href="<?= base_url('admin/artikel/add'); ?>">
